...
+ (PPRuleComponentState *)initScheduleStateComponent:(PPRuleComponentStateType)stateType {
    PPRuleComponentParameter *param1 = [[PPRuleComponentParameter alloc] initWithName:RULE_COMPONENT_STATE_SCHEDULE_COMPONENT_PAMAMETER_NAME_1 category:PPRuleComponentParameterCategoryCronExpression optional:PPRuleComponentParameterOptionalFalse desc:NSLocalizedStringFromTableInBundle(@"What is the start time, and on which days?", nil, [NSBundle bundleWithIdentifier:@"com.peoplepowerco.lib.Peoplepower.iOS"], @"Label - What is the start time, and on which days?") values:nil selectorName:nil value:nil minValue:PPRuleComponentParameterMinValueNone maxValue:PPRuleComponentParameterMaxValueNone valueType:PPRuleComponentParameterInputTypeNone unit:nil];
    
    PPRuleComponentParameter *param2 = [[PPRuleComponentParameter alloc] initWithName:RULE_COMPONENT_STATE_SCHEDULE_COMPONENT_PAMAMETER_NAME_2 category:PPRuleComponentParameterCategoryCronExpression optional:PPRuleComponentParameterOptionalFalse desc:NSLocalizedStringFromTableInBundle(@"What time should it end each day?", nil, [NSBundle bundleWithIdentifier:@"com.peoplepowerco.lib.Peoplepower.iOS"], @"Label - What time should it end each day?") values:nil selectorName:nil value:nil minValue:PPRuleComponentParameterMinValueNone maxValue:PPRuleComponentParameterMaxValueNone valueType:PPRuleComponentParameterInputTypeNone unit:nil];
    
    PPRuleComponentState *state = [[PPRuleComponentState alloc] initWithId:PPRuleComponentIdNone name:RULE_COMPONENT_STATE_SCHEDULE_COMPONENT_NAME stateType:stateType displayType:PPRuleComponentDisplayTypeStateGeneralCondition desc:NSLocalizedStringFromTableInBundle(@"$time1 and $time2", nil, [NSBundle bundleWithIdentifier:@"com.peoplepowerco.lib.Peoplepower.iOS"], @"Label - $time1 and $time2") past:NSLocalizedStringFromTableInBundle(@"between $time1 and $time2", nil, [NSBundle bundleWithIdentifier:@"com.peoplepowerco.lib.Peoplepower.iOS"], @"Label - between $time1 and $time2") timezone:PPRuleComponentTimezoneTrue functionGroup:nil parameters:(RLMArray *)@[param1, param2] serviceName:nil];
    return state;
}
