...
@property (nonatomic, strong) NSNumber<RLMInt> * length;
...
@property (nonatomic, strong) NSNumber<RLMInt> * enterDuration;
@property (nonatomic, strong) NSNumber<RLMInt> * exitDuration;
@property (nonatomic, strong) RLMArray<RLMInt> * compatibleBehaviors;
