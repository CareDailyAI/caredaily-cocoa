...
+ (void)updateUsername:(NSString * _Nullable )username altUsername:(NSString * _Nullable )altUsername password:(NSString * _Nullable )password firstName:(NSString * _Nullable )firstName lastName:(NSString * _Nullable )lastName communityName:(NSString * _Nullable )communityName email:(NSString * _Nullable )email emailResetStatus:(PPUserEmailStatus)emailResetStatus language:(NSString * _Nullable )language phone:(NSString * _Nullable )phone phoneType:(PPUserPhoneType)phoneType anonymous:(PPUserAnonymousType)anonymous medicalRecordNumber:(NSString * _Nullable)medicalRecordNumber accessibility:(PPUserAccessibility)accessibility pronounId:(PPUserPronounId)pronounId birthDate:(NSString * _Nullable)birthDate gender:(PPUserGender)gender userId:(PPUserId)userId callback:(PPErrorBlock _Nullable )callback {
    ...
    if(medicalRecordNumber) {
        userDict[@"medicalRecordNumber"] = medicalRecordNumber;
    }
    if(accessibility != PPUserAccessibilityNone) {
        userDict[@"accessibility"] = @(accessibility);
    }
    if(pronounId != PPUserPronounIdNone) {
        userDict[@"pronounId"] = @(pronounId);
    }
    if(birthDate) {
        userDict[@"birthDate"] = birthDate;
    }
    if(gender != PPUserGenderNone) {
...
+ (void)updateUsername:(NSString * _Nullable )username altUsername:(NSString * _Nullable )altUsername password:(NSString * _Nullable )password firstName:(NSString * _Nullable )firstName lastName:(NSString * _Nullable )lastName communityName:(NSString * _Nullable )communityName email:(NSString * _Nullable )email emailResetStatus:(PPUserEmailStatus)emailResetStatus language:(NSString * _Nullable )language phone:(NSString * _Nullable )phone phoneType:(PPUserPhoneType)phoneType anonymous:(PPUserAnonymousType)anonymous accessibility:(PPUserAccessibility)accessibility userId:(PPUserId)userId callback:(PPErrorBlock _Nullable)callback {
    NSLog(@"%s deprecated. Use +updateUsername:password:firstName:lastName:communityName:email:emailResetStatus:language:phone:phoneType:anonymous:medicalRecordNumber:accessibility:pronounId:birthDate:gender:userId:callback", __FUNCTION__);
    [PPUserAccounts updateUsername:username altUsername:altUsername password:password firstName:firstName lastName:lastName communityName:nil email:email emailResetStatus:emailResetStatus language:language phone:phone phoneType:phoneType anonymous:anonymous medicalRecordNumber:nil accessibility:PPUserAccessibilityNone pronounId:PPUserPronounIdNone birthDate:nil gender:PPUserGenderNone userId:userId callback:callback];
}
...
+ (void)addNewLocationToExistingUser:(NSString *)name type:(PPLocationType)type utilityAccountNo:(NSString *)utilityAccountNo timezone:(PPTimezone *)timezone addrStreet1:(NSString *)addrStreet1 addrStreet2:(NSString *)addrStreet2 addrCity:(NSString *)addrCity state:(PPState *)state country:(PPCountry *)country zip:(NSString *)zip latitude:(NSString *)latitude longitude:(NSString *)longitude size:(PPLocationSize *)size storiesNumber:(PPLocationStoriesNumber)storiesNumber roomsNumber:(PPLocationRoomsNumber)roomsNumber bathroomsNumber:(PPLocationBathroomsNumber)bathroomsNumber occupantsNumber:(PPLocationOccupantsNumber)occupantsNumber occupantsRanges:(NSArray *)occupantsRanges usagePeriod:(PPLocationUsagePeriod)usagePeriod heatingType:(PPLocationHeatingType)heatingType coolingType:(PPLocationCoolingType)coolingType waterHeaterType:(PPLocationWaterHeaterType)waterHeaterType thermostatType:(PPLocationThermostatType)thermostatType fileUploadPolicy:(PPLocationFileUploadPolicy)fileUploadPolicy userId:(PPUserId)userId appName:(NSString *)appName test:(PPLocationTest)test locationCallback:(PPUserAccountsAddLocationBlock)locationCallback __attribute__((deprecated)) {
    NSLog(@"%s deprecated, use +addNewLocationToExistingUser:type:utilityAccountNo:timezone:addrStreet1:addrStreet2:addrCity:state:country:zip:latitude:longitude:size:storiesNumber:roomsNumber:bathroomsNumber:occupantsNumber:occupantsRanges:usagePeriod:heatingType:coolingType:waterHeaterType:thermostatType:fileUploadPolicy:userId:appName:test:language:locationCallback:", __FUNCTION__);
    [PPUserAccounts addNewLocationToExistingUser:name type:type utilityAccountNo:utilityAccountNo timezone:timezone addrStreet1:addrStreet1 addrStreet2:addrStreet2 addrCity:addrCity state:state country:country zip:zip latitude:latitude longitude:longitude size:size storiesNumber:storiesNumber roomsNumber:roomsNumber bathroomsNumber:bathroomsNumber occupantsNumber:occupantsNumber occupantsRanges:occupantsRanges usagePeriod:usagePeriod heatingType:heatingType coolingType:coolingType waterHeaterType:waterHeaterType thermostatType:thermostatType fileUploadPolicy:fileUploadPolicy userId:userId appName:nil test:PPLocationTestNone language:nil locationCallback:locationCallback];
}
...
+ (void)addNewLocationToExistingUser:(NSString *)name type:(PPLocationType)type utilityAccountNo:(NSString *)utilityAccountNo timezone:(PPTimezone *)timezone addrStreet1:(NSString *)addrStreet1 addrStreet2:(NSString *)addrStreet2 addrCity:(NSString *)addrCity state:(PPState *)state country:(PPCountry *)country zip:(NSString *)zip latitude:(NSString *)latitude longitude:(NSString *)longitude size:(PPLocationSize *)size storiesNumber:(PPLocationStoriesNumber)storiesNumber roomsNumber:(PPLocationRoomsNumber)roomsNumber bathroomsNumber:(PPLocationBathroomsNumber)bathroomsNumber occupantsNumber:(PPLocationOccupantsNumber)occupantsNumber occupantsRanges:(NSArray *)occupantsRanges usagePeriod:(PPLocationUsagePeriod)usagePeriod heatingType:(PPLocationHeatingType)heatingType coolingType:(PPLocationCoolingType)coolingType waterHeaterType:(PPLocationWaterHeaterType)waterHeaterType thermostatType:(PPLocationThermostatType)thermostatType fileUploadPolicy:(PPLocationFileUploadPolicy)fileUploadPolicy userId:(PPUserId)userId callback:(PPErrorBlock)callback __attribute__((deprecated)) {
    NSLog(@"%s deprecated, use +addNewLocationToExistingUser:type:utilityAccountNo:timezone:addrStreet1:addrStreet2:addrCity:state:country:zip:latitude:longitude:size:storiesNumber:roomsNumber:bathroomsNumber:occupantsNumber:occupantsRanges:usagePeriod:heatingType:coolingType:waterHeaterType:thermostatType:fileUploadPolicy:userId:appName:test:language:locationCallback:", __FUNCTION__);
    [PPUserAccounts addNewLocationToExistingUser:name type:type utilityAccountNo:utilityAccountNo timezone:timezone addrStreet1:addrStreet1 addrStreet2:addrStreet2 addrCity:addrCity state:state country:country zip:zip latitude:latitude longitude:longitude size:size storiesNumber:storiesNumber roomsNumber:roomsNumber bathroomsNumber:bathroomsNumber occupantsNumber:occupantsNumber occupantsRanges:occupantsRanges usagePeriod:usagePeriod heatingType:heatingType coolingType:coolingType waterHeaterType:waterHeaterType thermostatType:thermostatType fileUploadPolicy:fileUploadPolicy userId:userId appName:nil test:PPLocationTestNone language:nil locationCallback:^(PPLocationId locationId, NSError *error) {
        callback(error);
    }];
}
 ...
 **/
+ (void)editLocation:(PPLocationId)locationId name:(NSString *)name type:(PPLocationType)type utilityAccountNo:(NSString *)utilityAccountNo timezone:(PPTimezone *)timezone addrStreet1:(NSString *)addrStreet1 addrStreet2:(NSString *)addrStreet2 addrCity:(NSString *)addrCity state:(PPState *)state country:(PPCountry *)country zip:(NSString *)zip latitude:(NSString *)latitude longitude:(NSString *)longitude size:(PPLocationSize *)size storiesNumber:(PPLocationStoriesNumber)storiesNumber roomsNumber:(PPLocationRoomsNumber)roomsNumber bathroomsNumber:(PPLocationBathroomsNumber)bathroomsNumber occupantsNumber:(PPLocationOccupantsNumber)occupantsNumber occupantsRanges:(NSArray *)occupantsRanges usagePeriod:(PPLocationUsagePeriod)usagePeriod heatingType:(PPLocationHeatingType)heatingType coolingType:(PPLocationCoolingType)coolingType waterHeaterType:(PPLocationWaterHeaterType)waterHeaterType thermostatType:(PPLocationThermostatType)thermostatType fileUploadPolicy:(PPLocationFileUploadPolicy)fileUploadPolicy test:(PPLocationTest)test language:(NSString *)language callback:(PPErrorBlock)callback {
...
+ (void)editLocation:(PPLocationId)locationId name:(NSString *)name type:(PPLocationType)type utilityAccountNo:(NSString *)utilityAccountNo timezone:(PPTimezone *)timezone addrStreet1:(NSString *)addrStreet1 addrStreet2:(NSString *)addrStreet2 addrCity:(NSString *)addrCity state:(PPState *)state country:(PPCountry *)country zip:(NSString *)zip latitude:(NSString *)latitude longitude:(NSString *)longitude size:(PPLocationSize *)size storiesNumber:(PPLocationStoriesNumber)storiesNumber roomsNumber:(PPLocationRoomsNumber)roomsNumber bathroomsNumber:(PPLocationBathroomsNumber)bathroomsNumber occupantsNumber:(PPLocationOccupantsNumber)occupantsNumber occupantsRanges:(NSArray *)occupantsRanges usagePeriod:(PPLocationUsagePeriod)usagePeriod heatingType:(PPLocationHeatingType)heatingType coolingType:(PPLocationCoolingType)coolingType waterHeaterType:(PPLocationWaterHeaterType)waterHeaterType thermostatType:(PPLocationThermostatType)thermostatType fileUploadPolicy:(PPLocationFileUploadPolicy)fileUploadPolicy test:(PPLocationTest)test callback:(PPErrorBlock)callback __attribute__((deprecated)) {
    NSLog(@"%s deprecated, use +editLocation:name:type:utilityAccountNo:timezone:addrStreet1:addrStreet2:addrCity:state:statezip:latitude:longitude:size:storiesNumber:roomsNumber:bathroomsNumber:occupantsNumber:occupantsRanges:usagePeriod:heatingType:coolingType:waterHeaterType:thermostatType:fileUploadPolicy:test:language:callback:", __FUNCTION__);
    [PPUserAccounts editLocation:locationId name:name type:type utilityAccountNo:utilityAccountNo timezone:timezone addrStreet1:addrStreet1 addrStreet2:addrStreet2 addrCity:addrCity state:state country:country zip:zip latitude:latitude longitude:longitude size:size storiesNumber:storiesNumber roomsNumber:roomsNumber bathroomsNumber:bathroomsNumber occupantsNumber:occupantsNumber occupantsRanges:occupantsRanges usagePeriod:usagePeriod heatingType:heatingType coolingType:coolingType waterHeaterType:waterHeaterType thermostatType:thermostatType fileUploadPolicy:fileUploadPolicy test:PPLocationTestNone language:nil callback:callback];
